        ...
        <div className="w-[100%]">
            ...
            <NavLink to={url} target="blank">
                <div className='flex mx-auto w-[90%] max-h-[84px] border-[3px] border-[#003B71] rounded-[8px] gap-[10px] font-family cursor-pointer items-center relative'>
                    <div className='bg-[#003B71] w-[21%] min-h-[80px]  max-h-[84px] rounded-[5px] text-white font-[600] 
                    ...
                    <div className='flex flex-col justify-center font-[600] lg:text-[18px] md:text-[15px] sm:text-[13px] leading-[25px] text-[#183059CC]'>
...
export const LinkCard2 = (data2) =>{
    ...
    return(
        ...
        <div className="flex flex-col w-[80%] font-family cursor-pointer gap-[14px] items-center justify-center m-auto">
            <div className="flex justify-between w-[100%] items-center">
                <div className='flex flex-col justify-center font-[500] lg:text-[18px] md:text-[15px] sm:text-[13px] leading-[25px] text-[#183059CC]'>
                                <span>{title1}</span>
                                 <span>{title2}</span>
                </div>
