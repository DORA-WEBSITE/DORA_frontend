        ...
        <Slider {...settings} className="max-w-2xl md:max-w-5xl mx-auto">
          {donors.map((donor, index) => (
            <div
              ...
              className="w-[15%] max-w-[160px] min-h-[234px] md:min-h-[246.59px] md:max-w-[220px] border-[1px] bg-white shadow-lg flex flex-col items-center p-4"
            >
              <div className="w-[100%] h-[120px] md:h-[200px] overflow-hidden border-2 border-gray-200 mb-4">
                <img
