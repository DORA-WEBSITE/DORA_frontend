    ...
    return (
        <div className='flex flex-col justify-center w-full md:min-h-[434px] my-10'>
            ...
            {isLoading ? (
                ...
                <Slider {...settings} className='flex w-[100vw] justify-evenly my-10'>

                    {
                        TestimonialData.map((data, index) => {
                            return (
                                <div className='flex flex-col font-family w-[40%] max-w-[450px] shadow-lg shadow-[#00000040] justify-center p-[15px] ml-[50px] my-5'
                                key={data.id || data.path || index}>
                                    <div className='flex gap-[27px]'>
                                        <img src={`http://localhost:3000/${data.path}`} alt='' className='w-[33%]' />
