...
//                 <div class="text-2xl font-bold text-[32px] font-poppins text-blue-900">Distinguished Alumnus Awards</div>
...
//                           <a href="https://alumni.iitr.ac.in/awards/daa/dadayaa"> <img src={arrow} alt=""/></a>
//                         </div>
//                     <hr class="h-0.5 bg-[#CCCCCC] border-none"></hr>
//                     <div class="flex justify-between items-center text-[18px] font-poppins mt-[25px] mb-[5px]">
//                         <div>DAA - 2019</div>
//                           <a href="https://alumni.iitr.ac.in/awards/daa/daac"> <img src={arrow} alt=""/></a>
//                     </div>
//                     <hr class="h-0.5 bg-[#CCCCCC] border-none"></hr>
//                     <div class="flex justify-between items-center text-[18px] font-poppins mt-[25px] mb-[5px]">
//                         <div>Distinguished Alumnus Award (DAA) 2018</div>
//                           <a href="https://alumni.iitr.ac.in/awards/daa/dalist"> <img src={arrow} alt=""/></a>
//                     </div>
//                     <hr class="h-0.5 bg-[#CCCCCC] border-none"></hr>
//                     <div class="flex justify-between items-center text-[18px] font-poppins mt-[25px] mb-[5px]">
//                         <div>Distinguished Alumnus Award (DAA) 2018</div>
...
//             </div>
//             <div class="shadow-lg shadow-[#BFBFBF]  w-4/5 mx-auto p-[60px] space-y-12">
//                 <div class="text-2xl font-bold text-[32px] font-poppins text-blue-900">Outstanding Service Awards</div>
//                 <div class="text-gray-700 ml-[35px]">
//                     <div class="flex justify-between items-center text-[18px] font-poppins mt-[25px] mb-[5px]">
//                         <div>DAA & DYAA 2019</div>
//                           <a href=""> <img src={arrow} alt=""/></a>
...
//                 </div>
//             </div>
//             <div class="shadow-lg shadow-[#BFBFBF]  w-4/5 mx-auto p-[60px] space-y-12 text-blue-900">
//                 <div class="text-2xl font-bold text-[32px] font-poppins">IIT Roorkee Research Awards</div>
//                 <div class="text-gray-700 ml-[35px]">
//                     <div class="flex justify-between items-center text-[18px] font-poppins mt-[25px] mb-[5px]">
...
//             </div>
//             <div class="shadow-lg shadow-[#BFBFBF]  w-4/5 mx-auto p-[60px] space-y-12 text-blue-900">
//                 <div class="text-2xl font-bold text-[32px] font-poppins">Ram Kumar Prize</div>
//                 <div class="text-gray-700 ml-[35px]">
//                     <div class="flex justify-between items-center text-[18px] font-poppins mt-[25px] mb-[5px]">
//                         <div>Partial Support for Visiting Institutions Abroad</div>
//                           <a href=""> <img src={arrow} alt=""/></a>
